...
if request("send")="ok" then
   ...
   <table width="600" border="1" cellpadding="3" bordercolor="#333333" style="border-collapse: collapse;">
		 ...
		 <tr><TD width=20% height=15 align="right" bgcolor="2424242"><span class="STYLE1">留言者IP地址</span></TD>
		 <td bgcolor="2424242"><%=rs("IP")%></td>
		 </tr>
		 <tr><TD align="right" width=20%><span class="STYLE1">留言日期</span></TD>
		 <td><%=rs("PostDate")%></td></tr>		 
		 <tr><TD width=20% align="right"><span class="STYLE1">留言人姓名</span></TD>
		 <td><%=rs("UserName")%>&nbsp;</td></tr>
		<tr><TD align="right" width=20%><span class="STYLE1">留言邮箱</span></TD>
		<td><%=rs("UserMail")%>&nbsp;</td></tr>
		<tr><TD align="right" width=20%><span class="STYLE1">留言网址</span></TD>
		<td><%=rs("url")%>&nbsp;</td></tr>
		<tr><TD align="right" width=20%><span class="STYLE1">其它联系方式</span></TD>
		<td><%=rs("qq")%>&nbsp;</td></tr>
		 <tr><TD align="right" width=20%><span class="STYLE1">内容</span></TD>
		 <td><textarea style="overflow:auto" name="comments" cols="60" rows="8"><%=Comments%></textarea></td></tr>
		 <tr><TD align="right" width=20% valign=top><span class="STYLE1">回复内容</span></TD>
		 <td><textarea style="overflow:auto" name="Replay" cols="60" rows="8"><%=replay%></textarea>&nbsp;</td></tr>

		<tr><TD align="right" width=20%><span class="STYLE1">是否固顶</span></TD><td><input type="radio" name="top" value="1" <%if rs("top")="1" then%>checked<%end if%>>
		  <span class="STYLE1">
			  固顶
			  <input type="radio" name="top" value="0" <%if rs("top")="0" then%>checked<%end if%>>
			  普通 </span></td>
		</tr>


		<tr><TD align="right" width=20%><span class="STYLE1">是否隐藏</span></TD>
		<td><input type="radio" name="Online" value="0" <%if rs("Online")="0" then%>checked<%end if%>>
			  <span class="STYLE1">隐藏
...
%>
共<%=totalrec%><span class="STYLE1">条留言</span> 
<%if currentpage = 1 then%>
