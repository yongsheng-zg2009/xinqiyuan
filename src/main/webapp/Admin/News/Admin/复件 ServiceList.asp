...
<table width="98%"  border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td height="25"><b><%=Homepage_title%> - <font color="#FF0000">预订管理</font></b></td>
  </tr>
  <tr>
...
%>
    ...
    <table width="100%" border="1" cellspacing="0" cellpadding="0" bordercolordark="#FFFFFF" bordercolorlight="#CCCCCC">
      <tr bgcolor="#799AE1">
        ...
        <td height="20" bgcolor="#799AE1"><div align="center"><font color="#FFFFFF">在线服务</font></div></td>
...
If s_cataid = "" Then
	If s_keyword <> "" Then
		sSql = "SELECT * FROM Message WHERE Title LIKE '%"&s_keyword&"%' ORDER BY SendTime DESC"
    Else
		sSql = "SELECT * FROM Message ORDER BY SendTime DESC"
	End If
Else
	If s_keyword <> "" Then
		sSql = "SELECT * FROM Message WHERE About = '"&s_cataid&"' and Title LIKE '%"&s_keyword&"%' ORDER BY SendTime DESC"
    Else
...
%>
        <tr>
          ...
          <td height="22" align="center" valign="middle" style="word-break:break-all;"><br> <%=oRs("Content")%><br></td>
