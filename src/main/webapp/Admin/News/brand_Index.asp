<%
sub photoshow(T_CataID,Pmcount,more,T_Special,page,T_title)
%>
<style type="text/css">
<!--
.utd {
  ...
  <tr>
    <td align="center" valign="bottom">
      ...
      <table  border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td align="center" valign="middle"><table width="150" height="120" border="0" cellpadding="0" cellspacing="1">
              <tr>
                <td align="center" valign="middle" background="images/roombg.gif"><a href="Article_view.asp?id=<%=oRs("D_id")%>&amp;cataid=<%=oRs("D_CataID")%>"><img  src="<%=oRs("D_Picture")%>" alt="水利图库" width="140" height="110" border="1" /></a></td>
              </tr>
          </table></td>
        </tr>
        <tr>
