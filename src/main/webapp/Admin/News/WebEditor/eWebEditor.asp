...
return true ;	 // 隐藏错误
	...
	<script>
		function pasteBreakFlag()
		{
			eWebEditor.document.body.focus();
			eWebEditor.document.selection.createRange().pasteHTML("<P>[$Page$]</P>");
			return false;
		}
	</script>
</head>
...
<tr><td height=25>
	...
	<td>
		...
		<td width=5></td>
		<td class=StatusBarBtnOff id=eWebEditor_PAGEBREAK style="vertical-align:bottom;"><a href="/" style="font-size:12px; color:#111111; text-decoration:none;" onclick="return pasteBreakFlag();">插入分页</a></td>
		</tr>
		</table>
	</td>
...
Sub InitButtonArray()
	...
	Do While Not oRs.Eof
		...
		Case 0
			aButtonHTML(i) = "<DIV CLASS=""" & oRs("B_Class") & """ TITLE=""" & oRs("B_Title") & """ onclick=""" & oRs("B_Event") & """><IMG CLASS=""Ico"" SRC=""SysImage/" & sStyleDir & "/" & oRs("B_Image") & """></DIV>"
		Case 1
