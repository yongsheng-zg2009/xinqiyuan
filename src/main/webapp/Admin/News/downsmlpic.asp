<%
sub downsmlpic(T_CataID,T_Num,T_Special)
Dim TempContent
...
TempContent=TempContent&"  <tr>" 
		...
		Else
			...
			Else
				fSql = "SELECT * FROM NewsData WHERE D_CataID LIKE '"&T_CataID&"%' and D_Picture <> '' ORDER BY D_SortID DESC"
			End If
...
TempContent=TempContent&"    </td></tr><tr><td style='border:#C9E5AE solid;border-width:1 1 1 1' align=center>"&left(fRs("D_Title"),9)&"</td></tr>"
				Loopno = Loopno-1
				End If
			fRs.MoveNext
			Loop
